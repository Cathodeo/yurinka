...
int text_roll(FILE *file, int line_numbers[6], char (*array1)[64], char (*array2)[16], char (*image_filenames)[64], char (*music_filenames)[64], char (*sfx_filenames)[64], char (*ambiance_filenames)[64]);
